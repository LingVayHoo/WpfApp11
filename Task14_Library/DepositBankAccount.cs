...
{
    public class DepositBankAccount : IAccount<BankAccount, BankAccount>
    {
        private BankAccount _bankAccount;

        public DepositBankAccount(string[] data)
        {
            SetValueMethod(data);
            ChangeAccountNumber();
        }
        ...
        {
            _bankAccount.AccountTypeInt = 1;
        }

        public void SetPersents(int persentValue)
        {
            _bankAccount.Persents = persentValue;
        }
    }
}
